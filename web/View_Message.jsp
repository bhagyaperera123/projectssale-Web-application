            ...
            function sendreply() {
                ...
                xmlhttp.onreadystatechange=function() {
                    if (xmlhttp.readyState==4 && xmlhttp.status==200) {
                        ...
                        if(te == 1){
                            window.location = "View_Message.jsp?id="+msgid;
                        }
                    }
                }
                ...
                xmlhttp.open("POST","sendreply?fromuser="+fid+"&msg="+msg+"&msgid="+msgid,true);
                xmlhttp.send();
            }
        </script>
    </head>
                ...
                <%
                    ...
                    if (hs.getAttribute("user") != null) {
                        if (request.getParameter("id") != null) {
                            ...
                            int to = Integer.parseInt(hs.getAttribute("user").toString());
                            int from_user = Model.Main.valid_url(request.getParameter("id"));
                            ...
                            if (0 < from_user) {
                                ...
                                System.out.println("si="+l.size());
                %>
                <br/>
                <br/>
                <br/>
                <input type="hidden" value="<%=msgid%>" id="msgid">
                <h1><samp>Conversation</samp></h1>
