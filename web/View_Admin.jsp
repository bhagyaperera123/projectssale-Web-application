...
<html>
    ...
    <body style="">
        ...
        <div class="main">
            <div >
                <h2 class="bg-primary" style="padding-left: 100px"><samp>View All Admin</samp></h2>
                        ...
                        <tbody>
                            <%
                                ...
                                for (DB.UserLogin u : l) {
                                    if (u.getUserType().getIdUserType() != 2 & u.getUserType().getIdUserType() != 5) {
                            %>
                            <tr>
                                ...
                                <%} else if (u.getStatus() == 2) {%>
                                <td>
                                    <button onclick="Unblock_User(<%=u.getUser().getIduser()%>)" type="button" class="btn btn-default"><span class="glyphicon glyphicon-lock"></span> Unblock</button>     
                                </td>
                                <%} else if (u.getStatus() == 0) {%>
                                <td>
