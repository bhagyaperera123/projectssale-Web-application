...
<html>
            ...
            function Active_proects(typeid){
                xmlhttp.onreadystatechange=function() {
                    if (xmlhttp.readyState==4 && xmlhttp.status==200) {
                        ...
                        if(te == 1){
                            window.location.href = "Manage_Projects.jsp";
                            alert('Success'); 
                        }
                    }
                }
    ...
    <body style="">
        <%
            ...
            DB.UserPage up1 = (DB.UserPage) sess.load(DB.UserPage.class, 14);
        ...
        <div class="main">
            <div class="container">
                ...
                <h2 class="bg-primary" style="padding-left: 100px"><samp>Activate Projects</samp></h2>
                <br/>
                <br/>
