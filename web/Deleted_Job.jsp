...
<html>
    <head>
        ...
        <script>
            ...
            function Active_job(typeid){
                xmlhttp.onreadystatechange=function() {
                    if (xmlhttp.readyState==4 && xmlhttp.status==200) {
                        var te = xmlhttp.responseText;  
                        if(te == 1){
                            window.location.href = "Deleted_Job.jsp";
                            alert('Success'); 
                        }
                    }
                }
                xmlhttp.open("POST","active_job?id="+typeid,true);
                xmlhttp.send();
            }          
    ...
    <body style="">
        <%
            ...
            DB.UserPage up1 = (DB.UserPage) sess.load(DB.UserPage.class, 11);
        ...
        <div class="main">
            <div class="container">
                ...
                <h2 class="bg-primary" style="padding-left: 100px"><samp>Deleted Jobs</samp></h2>
                <br/>
                <br/>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-default" onclick="Active_job(<%=ul.getIdaddJob()%>)"> Activate</button>
                                </td>
                            </tr>
                            <%}
                                }%>
