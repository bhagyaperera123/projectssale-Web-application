...
<html>
    <head>
        ...
        <script>
            ...
            function Active_proects(typeid){
                xmlhttp.onreadystatechange=function() {
                    if (xmlhttp.readyState==4 && xmlhttp.status==200) {
                        var te = xmlhttp.responseText;  
                        if(te == 1){
                            window.location.href = "Deleted_Projects.jsp";
                            alert('Success'); 
                        }
                    }
                }
                xmlhttp.open("POST","active_projects?id="+typeid,true);
                xmlhttp.send();
            }
    ...
    <body style="">
        ...
        <%
            ...
            DB.UserPage up1 = (DB.UserPage) sess.load(DB.UserPage.class, 12);
        ...
        <div class="main">
            <div class="container">
                ...
                <h2 class="bg-primary" style="padding-left: 100px"><samp>Deleted Projects</samp></h2>
                <br/>
                <br/>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-default" onclick="Active_proects(<%=ul.getIdprojects()%>)"> Activate</button>
                                </td>
                            </tr>
                            <%}
                                }%>
