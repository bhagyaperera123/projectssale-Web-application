...
<html>
            ...
            function Active_job(typeid){
                xmlhttp.onreadystatechange=function() {
                    if (xmlhttp.readyState==4 && xmlhttp.status==200) {
                        ...
                        if(te == 1){
                            window.location.href = "Manage_Job.jsp";
                            alert('Success'); 
                        }
                    }
                }
    ...
    <body style="">
        ...
        <%
            ...
            DB.UserPage up1 = (DB.UserPage) sess.load(DB.UserPage.class, 13);
        ...
        <div class="main">
            <div class="container">
                ...
                <h2 class="bg-primary" style="padding-left: 100px"><samp>Activate Job</samp></h2>
                <br/>
                <br/>
